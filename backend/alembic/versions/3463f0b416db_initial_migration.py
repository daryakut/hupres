...
# Make sure we can only run this in a local environment
db_hostname = os.environ.get('HUPRES_POSTGRES_HOSTNAME')
assert db_hostname == "localhost"
...
def upgrade() -> None:
    ...
    op.create_table('quiz_answers',
                    ...
                    sa.Column('answer_names', sa.JSON(), nullable=True),
