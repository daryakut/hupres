...
from tests.test_utils.user_tester import UserTester, AnonymousUserTester
...
async def test_anonymous_user_can_create_quiz():
    ...
    anonymous_user_tester = await AnonymousUserTester.visit()
...
async def test_logged_in_user_can_create_quiz():
    ...
    user_tester = await UserTester.login_with_google()
